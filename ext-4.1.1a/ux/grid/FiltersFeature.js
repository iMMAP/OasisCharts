...
Ext.define('Ext.ux.grid.FiltersFeature', {
    ...
    attachEvents: function() {
        ...
        grid.addEvents('afterfilterupdate');
    },
    ...
    createFilters: function() {
        ...
        function add (dataIndex, config, filterable, grid) {
        ...
        Ext.Array.each(me.filterConfigs, function (filterConfig) {
            add(filterConfig.dataIndex, filterConfig, filterConfig, grid);
        });
        ...
        Ext.Array.each(grid.columns, function (column) {
            if (column.filterable === false) {
                ...
                add(column.dataIndex, column.filter, column.filterable,grid);
            }
        });
    ...
    reload : function () {
        ...
        if (me.local) {
            ...
            grid.fireEvent('afterfilterupdate',this);
        } else {
            me.deferredUpdate.cancel();
            if (store.buffered) {
                store.pageMap.clear();
